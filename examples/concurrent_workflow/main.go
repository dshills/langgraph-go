...
func (n *FetchPapersNode) Run(_ context.Context, state ResearchState) graph.NodeResult[ResearchState] {
...
func (n *FetchNewsNode) Run(_ context.Context, state ResearchState) graph.NodeResult[ResearchState] {
...
func (n *FetchSocialNode) Run(_ context.Context, state ResearchState) graph.NodeResult[ResearchState] {
...
func (n *FetchPatentsNode) Run(_ context.Context, state ResearchState) graph.NodeResult[ResearchState] {
